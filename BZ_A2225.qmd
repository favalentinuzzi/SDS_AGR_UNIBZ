---
title: "Lab A2.2.25 - Advanced Technologies Lab"
---
...
# filtering for Lab
lista <- subset(lista_tot, lab=="A2.2.25")

colnames(lista) <- c("lab", "filter_name", "Shelf", "Name", "Weight", "Unit", "Producer", "Quantity", "CAS", "sds")
...
::: {.callout-note}
**Laboratory Responsible**: Matteo Scampicchio - [email](mailto:matteo.scampicchio@unibz.it)

**Laboratory Technician**: Ksenia Morozova - [email](mailto:ksenia.morozova@unibz.it) [phone](tel:+390471017211) 
