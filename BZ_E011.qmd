---
title: "Lab E0.11 - Laboratory for Agro-Environmental Science"
---
...
# filtering for Lab
lista <- subset(lista_tot, lab=="E0.11")
...
::: {.callout-note}
**Laboratory Responsible**: Enrico Tomelleri - [email](mailto:enrico.tomelleri@unibz.it)
